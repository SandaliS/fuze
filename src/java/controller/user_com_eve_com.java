 ...
 * @author Saroj
 */
@WebServlet(name = "user_com_eve_com", urlPatterns = {"/user_com_eve_com"})
public class user_com_eve_com extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher r = request.getRequestDispatcher("user_add_comp_event_comments.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DB.iud("INSERT INTO `user_comp_event_comment`(`com_id`, `uid`, `uni_id`, `eid`, `comment`) VALUES ('" + cid + "','" + uid + "',"

 ...
 * @author Saroj
 */
@WebServlet(name = "uni_com_eve_com", urlPatterns = {"/uni_com_eve_com"})
public class uni_com_eve_com extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher r = request.getRequestDispatcher("uni_add_comp_event_comments.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet searchui = DB.search("SELECT `id` FROM `university` WHERE `uname` = '" + name + "'");
            if (searchui.next()) {
            ...
            DB.iud("INSERT INTO `uni_com_eve_com`(`com_id`, `uid`, `uni_id`, `eid`, `comment`) VALUES ('" + cid + "','" + uid + "',"
    ...
    public List<unieventbean> progectdetails(String name, HttpServletRequest request) throws Exception {
        ...
        ResultSet rs = DB.search("SELECT * FROM `comp_event` WHERE `eid` ='" + request.getParameter("evid") + "'");
        while (rs.next()) {

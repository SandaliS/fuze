 ...
 * @author Saroj
 */
@WebServlet(name = "comp_event_image_controller", urlPatterns = {"/comp_event_image_controller"})
public class comp_event_image_controller extends HttpServlet {
 String Eid = "";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String path = "C:\\Users\\Saroj\\Documents\\NetBeansProjects\\Konnect\\web\\comp_images";
        String str = "";
        int idd = 0;
        int imid = 0;
        String id = "";
        ...
        if (type.indexOf("multipart/form-data") >= 0) {
            try {
                ...
                String query = "UPDATE `comp_event` SET `savepath` = '" + str + "' WHERE `eid` = '" + Eid + "'";
                DB.iud(query);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher r = request.getRequestDispatcher("company_add_event_step_3.jsp");
    ...
    public List<unieventbean> progectdetails() throws Exception {
        ...
        ResultSet rs = DB.search("SELECT * FROM `comp_event` WHERE `eid` = '" + Eid + "'");
        while (rs.next()) {

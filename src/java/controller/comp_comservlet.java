 ...
 * @author Saroj
 */
@WebServlet(name = "comp_comservlet", urlPatterns = {"/comp_comservlet"})
public class comp_comservlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher r = request.getRequestDispatcher("comp_uni_comments.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DB.iud("INSERT INTO `comp_uni_event_comment`(`com_id`, `uid`, `uni_id`, `eid`, `comment`) VALUES ('" + cid + "','"+uid+"',"

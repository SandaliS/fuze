 ...
 * @author Saroj
 */
@WebServlet(name = "uni_view_comments", urlPatterns = {"/uni_view_comments"})
public class uni_view_comments extends HttpServlet {
String name = "";
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher r = request.getRequestDispatcher("uni_view_comments.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DB.iud("INSERT INTO `user_uni_event_comment`(`com_id`) VALUES ('"+cid+"')");
             DB.iud("INSERT INTO `uni_comm`(`com_id`, `uid`, `uni_id`, `eid`, `comment`) VALUES ('" + cid + "','" + uid + "',"

...
@WebServlet(name = "userviewevents", urlPatterns = {"/userviewevents"})
public class userviewevents extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            RequestDispatcher r = request.getRequestDispatcher("userviewunievents.jsp");

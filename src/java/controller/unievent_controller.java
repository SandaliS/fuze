...
@WebServlet(name = "unievent_controller", urlPatterns = {"/unievent_controller"})
public class unievent_controller extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "INSERT INTO `uni_event`(`eid`, `title`, `type`, `cnum`, `location`, `address`, `startdate`, `starttime`, `enddate`, `endtime`, `description`, `calstart`, `calend`, `uid`)"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher r = request.getRequestDispatcher("uni_add_event_step2.jsp");
    ...
    public List<unieventbean> progectdetails(String id) throws Exception {
        ...
        ResultSet rs = DB.search("SELECT * FROM `uni_event` WHERE `eid` = '" + id + "'");
        while (rs.next()) {

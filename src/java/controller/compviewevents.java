...
@WebServlet(name = "compviewevents", urlPatterns = {"/compviewevents"})
public class compviewevents extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            RequestDispatcher r = request.getRequestDispatcher("comp_view_uni_events.jsp");
    ...
    public List<unieventbean> progectdetails(String name) throws Exception {
        ...
        ResultSet rs = DB.search("SELECT * FROM `uni_event`");
        while (rs.next()) {

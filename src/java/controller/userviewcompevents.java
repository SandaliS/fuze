 ...
 * @author Saroj
 */
@WebServlet(name = "userviewcompevents", urlPatterns = {"/userviewcompevents"})
public class userviewcompevents extends HttpServlet {
 ...
 @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            RequestDispatcher r = request.getRequestDispatcher("userviewcompevents.jsp");
